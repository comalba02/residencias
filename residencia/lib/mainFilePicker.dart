...
class MyApp extends StatelessWidget {
  ...
  void _uploadFile() async {
    ...
    var uri = Uri.parse('https://miventanilla.palmarescorocora.com/residencia/pdff');
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [ElevatedButton(onPressed: _openFileExplorer, child: Text('Open File Explorer')), ElevatedButton(onPressed: _uploadFile, child: Text('Upload File'))],
        ),
      ),
    );
  }
